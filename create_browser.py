      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Recent Release in Hollywood</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <h2>{movie_title}</h2>
    <h6 style="text-align:left;"><b>Genre: </b>{movie_genre}
    <span style="float:right;"><b>IMDb Rating: </b>{movie_rating}</span></h6>
    <p style="text-align:left;"><b>Story Line: </b>{movie_story}</p>
</div>
'''
